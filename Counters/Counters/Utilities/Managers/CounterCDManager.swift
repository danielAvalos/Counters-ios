...
struct CounterCDManager {

    static var isDataChanged = false

    static func saveCounter(title: String, _ id: String? = nil) -> Bool {
        ...
        guard let id = id,
           let result = existsValidate(id: id),
           result.isEmpty else {
            return false
        }
    ...
    static func existsValidate(id: String) -> [NSManagedObject]? {
